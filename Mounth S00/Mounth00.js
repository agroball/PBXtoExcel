...
//*2323
    connection.query(
        `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in ('74952491625') and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
...
//GIBDD
    ...
    connection.query(
        `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in (${elementNUmberGibdd}) and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
        function (err,results) {
            console.log(results);
...
//CPU330
    connection.query(
        `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in ('74822360279') and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
        function (err,results) {
            console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in (${elementNUmberMtts}) and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function (err,results) {
        console.log(results);
...
//avtodor
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in ('74952499390') and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in (${elementNUmberRas}) and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in (${elementNUmberTsi}) and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}' and src in (${elementNUmberEva}) and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${mounthStart}' and calldate < '${mounthEnd}'  and disposition = 'ANSWERED' and dst = '9995' ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
    }
);
