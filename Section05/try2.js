...
//*2323
    connection.query(
        `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in ('84952491625', '84952499390') and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
...
//GIBDD
    ...
    connection.query(
        `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in (${elementNUmberGibdd}) and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
        function (err,results) {
            console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in (${elementNUmberMtts}) and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
    function (err,results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in (${elementNUmberRas}) and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in (${elementNUmberTsi}) and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}' and src in (${elementNUmberEva}) and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
...
connection.query(
    `select count(*) from cdr where calldate > '${formatDateStart}' and calldate < '${formatDateEnd}'  and disposition = 'ANSWERED' and dst in ('2004', '2001', '2002', '2003', '2005', '2011', '2012', '2013', '2014', '2022', '2024') ORDER BY calldate DESC`,
    function(err, results) {
        console.log(results);
    }
);
